...
var gcCellBG="#B7D8FB";	// default background color of the cells. Use "" for transparent!!!
...
var gAgendaMask=[-1,-1,-1,-1,null,null,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.php. Check the tutorial for details.

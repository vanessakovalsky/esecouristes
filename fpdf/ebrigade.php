...
class PDFEB extends FPDI
{
	...
	function FicheSection($id=0){
		global $cisname;
		$section= array(); 
		$sql = "select s_code, s_description, s_address, s_zip_code, s_phone, s_city, s_cedex, s_email,

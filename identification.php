...
if ( is_file ( 'images/user-specific/banniere.jpg' ))
	echo "<img src=images/user-specific/banniere.jpg>";
...
<TD class='FondMenu'>
  <table width='343' cellspacing='0' border='0' height='147'>
    ...
    <tr bgcolor='$mylightcolor'> 
      <td rowspan=3><img src=images/lock.png></td>
      <td><b>$str</b></td>
  ...
  <i><font size=1 color='#3333FF'><a href=lost_password.php>mot de passe perdu</a></font></i><p>";

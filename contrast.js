...
var gsOutOfRange="Attention : la date choisie n'est pas possible!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
var guOutOfRange="images/expand.gif";	// the background image url for the out-range dates. e.g. "outrange.gif"
...
var gAgendaMask=[-1,-1,gcCellBG,"black",-1,false,null];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.php. Check the tutorial for details.

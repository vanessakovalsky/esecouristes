...
// permettre les modifications si je suis habilit� sur la fonctionnalit� 17 au bon niveau
...
if ( $VP_OPERATIONNEL < 0 ) {
	if ( $MA_UPDATE_DATE <> "" )
       ...
       if ( $MA_UPDATE_BY <> "") 
       echo "<tr> 
              <td bgcolor=$mylightcolor align=right><i>Modifi� par: </i></td> 
              <td bgcolor=$mylightcolor align=left> 
...
//=====================================================================
// personne ayant effectuer le contr�le
//=====================================================================

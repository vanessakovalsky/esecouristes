...
$c->setPlotArea(60, 60, 520, 200, 0xeeeeee, -1, 0xcccccc, 0xccccccc);
...
$textBoxObj = $c->addTitle("CA pour les événements de l'année $year", "arialbd.ttf", 15,0xffffff);
...
$legendObj = $c->addLegend(70, 280, false, "arialbd.ttf", 9);
...
$c->yAxis->setTitle("Chiffre d'affaire en euros");

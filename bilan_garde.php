...
url = "bilan_garde.php?month="+month+"&year="+year+"&section="+section;
...
echo "<body>";
echo "<div align=center><font size=5><b>Répartition des gardes</b></font><p>";
...
// histogram
// =====================================================================   
echo "<img src=bilan_garde_pic.php?year=$year&month=$month&section=$section><p>" ;

...
var gMonths=["JAN","FEV","MAR","AVR","MAI","JUN","JUL","AUG","SEP","OCT","NOV","DEC"];
...
var gcCalBG="#B7D8FB";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#B7D8FB";	// the background color of the inner table, showing as a frame.
...
var giCellWidth=80; // calendar cell width; if set to -1, it'll be auto-adjusted so as to ensure the width of the entire calendar fits in with the calendar's direct parent tag. NN4 doesn't support -1.
var giCellHeight=100;	// calendar cell height;
...
var gsWeeks="Semaine";	// the dynamic statement to be eval()'ed into the week-number-column. e.g. "'week '+weekNo" will show "week 1", "week 2" ...

var gcWorkday="#000099";	// Workday font color
var gcSat="red";	// Saturday font color
var gcSatBG="#FFFF99";	// Saturday background color
var gcSun="red";	// Sunday font color
var gcSunBG="#FFFF99";	// Sunday background color
...
var gcFGSelected="#000099";	// the font color for the selected date
...
var gAgendaMask=[-1,-1,-1,-1,-1,-1,-1];	// [message, action, bgcolor, fgcolor, bgimg, boxit, html] - Set the relevant bit to -1 to keep the original agenda/event value of that bit intact. Any other value will be used to override the original one defined in agenda.php. Check the tutorial for details.
